                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            while ($rws = $rs->fetch_assoc()) {
                                ...
                                <tr>
                                    ...
                                    <td><a
                                                href="javascript:sureToApprove2(<?php echo $rws['car_plateid']; ?>)"
    ...
    <!-- Box -->
                <div class="box">
                    ...
                    <div class="box-content">
                        ...
                        if (isset($_SESSION['daystatus'])) {
                            if(isset($_SESSION['car_plateid'])){
                                $tempday = $_SESSION['daystatus'];
                                $crid= $_SESSION['car_plateid'];
                                $sqldaystatus = " SELECT *FROM `STATUS` S WHERE $crid=S.car_plateid AND ($tempday <= S.return_day  AND $tempday >=S.day) OR ( S.return_day IS NULL  AND $tempday >=S.day) ";
                                $rs = mysqli_query($conn, $sqldaystatus);
                                if($rs){
                                   
                                    echo "on ";
                                    echo $tempday;
                                    echo " where car plate id =  ";
                                    echo $crid;
                                    echo " status is Out of Service  ";
