            ...
            while ($rws = $rs->fetch_assoc()) {
                ...
                <li>
                    ...
                    <div class="property_details">
                        <h1>
                            <a href="Reservation.php?id=<?php echo $rws['car_plateid'] ?>"><?php echo 'Car Make>' . $rws['car_model']; ?></a>
                        </h1>
                        <h2>Car Name/Model: <span class="property_size"><?php echo $rws['car_color']; ?></span></h2>
