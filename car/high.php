...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark static-top">
  ...
  <?php
              $highprice = "SELECT * FROM cars order by hire_cost DESC ";   
                   $hp = $conn->query($highprice);
						while($ress = $hp->fetch_assoc()){
                     
          
            ?>
            <li>
					<a href="Reservation.php?id=<?php echo $rws['car_plateid'] ?>">
						<img class="thumb"  src="assets/images/<?php echo $ress['image'];?>" width="300" height="200">
            
					</a>
					<span class="price"><?php echo 'pound.'.$ress['hire_cost'];?></span>
					<div class="property_details">
						<h1>
							<a href="Reservation.php?id=<?php echo $ress['car_plateid'] ?>"><?php echo 'Car Make>'.$ress['car_model'];?></a>
						</h1>
						<h2>Car Name/Model: <span class="property_size"><?php echo $ress['car_color'];?></span></h2>
            <h2>Car Capacity: <span class="property_size"><?php echo $ress['capacity'];?></span></h2>
