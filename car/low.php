...
<section class="listings">
    <div class="wrapper">
        <ul class="properties_list">
            ...
            $lowprice = "SELECT * FROM cars order by hire_cost ";
            $lp = $conn->query($lowprice);
            while ($res = $lp->fetch_assoc()) {


                ?>
                <li>
                    <a href="Reservation.php?id=<?php echo $rws['car_plateid'] ?>">
                        <img class="thumb" src="assets/images/<?php echo $res['image']; ?>" width="300" height="200">

                    </a>
                    <span class="price"><?php echo 'pound.' . $res['hire_cost']; ?></span>
                    <div class="property_details">
                        <h1>
                            <a href="Reservation.php?id=<?php echo $rws['car_plateid'] ?>"><?php echo 'Car Make>' . $res['car_model']; ?></a>
                        </h1>
                        <h2>Car Name/Model: <span class="property_size"><?php echo $res['car_color']; ?></span></h2>
