    ...
    <div class="banner">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <div class="caption">
              <h2>Yourcar rental website </h2>
              <div class="line-dec"></div>
              <p><strong>Oops </strong>seems that this car is already reserved !
              <br><br>Please Choose another  Thank you.
              <div class="main-button">
                <a href="products.php">Review cars again!</a>
              </div>
            </div>
          </div>
        </div>
