...
<form name="Form" action="" method="post">
    ...
    <section class="search">
        <div class="wrapper">
            <div id="fom">
                <form method="post">
                    <h3 style="text-align:center; color: #000099; font-weight:bold; text-decoration:underline">Admin
                        Login Area</h3>
    ...
    if ($email != '' && $password != '') {
        ...
        if ($result->num_rows > 0) {
            if ($db_pass === md5($password) || $db_pass == ($password)) {
                $admin_ssn = $row['admin_ssn'];
                $_SESSION['admin_ssn'] = $admin_ssn;
                ...
                echo '<script >';
                echo 'window.location="admin_tab.php"';
                echo '</script>';
                exit;
            }
        } else {
